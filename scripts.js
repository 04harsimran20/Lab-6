/****************** YOUR NAME: Harsimran Preet Singh */
...
function recalculate() {
    ...
    const cost = modelPrices[modelName] * duration;
...
- second, create a function called changeModel() which checks the value of the modelName variable. This function will:
...
function changeDuration() {
    ...
    const userInput = prompt("Enter the duration (in days):");
    if (!isNaN(userInput) && userInput >= 0) {
        duration = parseFloat(userInput);
        durationText.innerHTML = userInput;
        recalculate();
    } else {
